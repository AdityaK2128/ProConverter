...
struct PowerConversionView: View {
...
#Preview {
   PowerConversionView(isPresented: .constant(false)) // Initialize with false or true based on your needs
}
